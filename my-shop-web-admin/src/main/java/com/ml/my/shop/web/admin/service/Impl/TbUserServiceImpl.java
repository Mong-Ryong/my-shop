package com.ml.my.shop.web.admin.service.Impl;

import com.ml.my.shop.commons.dto.BaseResult;
import com.ml.my.shop.commons.utils.RegexpUtils;
import com.ml.my.shop.domain.TbUser;
import com.ml.my.shop.web.admin.dao.TbUserDao;
...
public class TbUserServiceImpl implements TbUserService {
    ...
    public TbUser login(String email, String password) {
        ...
        if (tbUser != null) {
            ...
            //判断加密后后的密码和数据库中存放的密码是否匹配，匹配则表示允许登录
